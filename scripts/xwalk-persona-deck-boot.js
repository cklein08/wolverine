...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      'body.xwalk-persona-offer-page header{display:block!important;visibility:visible!important;z-index:200!important;background:' +
        HERO_BG +
        '!important}',
  ...
  function build(parsed, cfg) {
    ...
    root.innerHTML =
      '<section class="xwalk-mockup-intro"><p class="xwalk-mockup-logo"><a href="/"><img src="' +
      logo +
      '" alt="Wolverine Mobile" width="40" height="40"></a></p><p class="xwalk-mockup-ai-badge">' +
      BADGE +
      '</p><h1>' +
      parsed.headline +
      '</h1></section><div class="xwalk-mockup-green-bar">' +
      BADGE +
